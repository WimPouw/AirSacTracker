...
timeseries -> this is has the csv's with the timeseries PER VIDEO, such that filename is same as video (minus the extension name), and there is an x and y and radius variable which is used to draw the circle
