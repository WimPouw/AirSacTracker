ReadMe for: function_from_dlc_to_radius.R
...
as batch processing. 
For the corresponidngs cript, adding the necessary metadata for the project specific data please see 
the script: analysis_from_dlc_to_radius.R
