...
- ToolkitR --> contains all codes from the Toolkit, but in R instead of Python
...
This folder contains the scripts from the Toolkit in R instead of Python. For more detailed information check the toolkit folder (tk).
